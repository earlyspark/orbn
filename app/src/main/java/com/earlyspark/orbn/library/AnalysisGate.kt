 ...
 *
 * Batch analysis ([TaggingWorker]) is memory-heavy: it decodes whole tracks,
 ...
 *
 * The visualizer raises this flag while it is resumed; the worker checks it
 * between tracks and backs off (reschedules) until the visualizer is gone.
 */
object AnalysisGate {
